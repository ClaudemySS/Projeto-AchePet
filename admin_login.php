...
if(isset($_POST['submit'])){
   ...
   $select_admin = $conn->prepare("SELECT * FROM `administrador` WHERE email = ? AND password = ?");
...
<head>
   ...
   <title>Login Admin - AchePet</title>
...
<section class="bg-white p-8 rounded-xl shadow-lg w-full max-w-sm">
   <form action="" method="post">
      ...
      <p class="text-center text-sm text-gray-600 mt-4">
         Não tem conta? <a href="admin_register.php" class="text-blue-600 hover:underline">Cadastre-se</a>
      </p>
   </form>
</section>
